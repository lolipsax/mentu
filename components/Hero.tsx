      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto">
          <div className="inline-flex items-center gap-2 bg-mentu-red/5 border border-mentu-red/10 rounded-full px-4 py-1.5 mb-8">
            ...
            <span className="text-sm font-medium text-mentu-red">MENTU Mobil Uygulaması Yayında</span>
          </div>
          ...
          <p className="text-xl text-gray-600 mb-10 leading-relaxed px-4">
            ...
            Uzman olduğunuz konularda ders verin veya hayalinizdeki eğitimi alın.
          </p>
          
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button className="w-full sm:w-auto bg-mentu-red text-white px-8 py-4 rounded-xl font-bold text-lg hover:bg-mentu-redLight transition-transform transform hover:-translate-y-1 shadow-lg shadow-mentu-red/30 flex items-center justify-center gap-2">
          ...
          <div className="mt-16 pt-8 border-t border-gray-100 grid grid-cols-3 gap-8 text-center">
            <div className="flex flex-col items-center">
                ...
                <h3 className="font-bold text-gray-900">Geniş Topluluk</h3>
            ...
            <div className="flex flex-col items-center">
                ...
                <h3 className="font-bold text-gray-900">Hızlı İletişim</h3>
                <p className="text-sm text-gray-500 mt-1">Anlık mesajlaşma sistemi</p>
            </div>
          </div>
        </div>
      </div>
